      ...
      body: BlocProvider(
              ...
              child: GestureDetector(
                ...
                child: CircleAvatar(
                  ...
                  radius: MediaQuery
                      .of(context)
                      .size
                      .width * 0.25 * MediaQuery.textScaleFactorOf(context),
                  child: Column(
                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        children: [
                          ...
                          showError ? Text("Please select an image",
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              height: 150, width: 150, color: Colors.grey
                                .shade300,
                              child: hasPartnerImage ? Image.file(
                                  partnerImageFile) : Center(
                                child: Text("Add photo"),),
                            ),
                          ),
                          showPartnerError ? Text("Please select an image",
                            style: TextStyle(color: Colors.red),) : SizedBox()
                        ],
                      ),),
        ...
        BlocBuilder<ResultsBloc, ResultsState>(
          builder: (context, state) {
            ...
            return Column(
              children: [
                state.status == ResultsStatus.loaded ? Text(
                    "Your test results were submitted successfully",
                    style: TextStyle(color: Colors.green, fontSize: 16)) :
                state.status == ResultsStatus.error
                    ? Text("There was an error submitting your test results ",
                ...
                state.status == ResultsStatus.loaded ? SizedBox() : Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      _stopTimer();
                      resultsBloc.add(UploadResults(context: context,
