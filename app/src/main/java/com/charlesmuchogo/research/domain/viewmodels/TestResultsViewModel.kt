...
@HiltViewModel
class TestResultsViewModel @Inject constructor(private val remoteRepository: RemoteRepository, private val database: AppDatabase): ViewModel() {
    ...
    private fun getTestResults() {
        viewModelScope.launch {
            ...
            database.testResultsDao().getTestResults().catch {
