...
@Database(entities = [User::class, TestResult::class, Clinic::class, TestProgress::class, Message::class, Article::class, FavoriteArticle::class], version = 10, exportSchema = false)
